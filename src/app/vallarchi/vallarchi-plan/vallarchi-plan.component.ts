...
@Component({
  selector: 'app-vallarchi-plan',
  templateUrl: './vallarchi-plan.component.html',
  styleUrls: ['./vallarchi-plan.component.scss']
})
export class VallarchiPlanComponent implements OnInit {
